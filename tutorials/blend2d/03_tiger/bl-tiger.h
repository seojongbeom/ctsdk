...
extern void onRenderB2D(BLContext& ctx, const int width, const int height, const double _rot, const double _scale, const bool _cacheStroke, const bool _renderStroke) noexcept;
#endif // BL_QT_TIGER_H
